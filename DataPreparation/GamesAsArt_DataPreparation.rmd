...
AESTHEMOS1 <- c("IntellectualChallenge_1_AESTHEMOS","Relaxation_1_AESTHEMOS","FeelingOfBeauty_1_AESTHEMOS","Enchantment_1_AESTHEMOS","IntellectualChallenge_2_AESTHEMOS","FeelingOfUgliness_1_AESTHEMOS","BeingMoved_1_AESTHEMOS","Energy_1_AESTHEMOS","Enchantment_2_AESTHEMOS","Relaxation_2_AESTHEMOS","Humor_1_AESTHEMOS","Confusion_1_AESTHEMOS","Nostalgia_1_AESTHEMOS","Nostalgia_2_AESTHEMOS","Uneasiness_1_AESTHEMOS", "Vitality_1_AESTHEMOS", "Fascination_1_AESTHEMOS", "BeingMoved_2_AESTHEMOS", "Interest_1_AESTHEMOS", "Awe_1_AESTHEMOS", "Humor_2_AESTHEMOS")

AESTHEMOS2 <- c("FeelingOfBeauty_2_AESTHEMOS", "Joy_1_AESTHEMOS", "Interest_2_AESTHEMOS", "Fascination_2_AESTHEMOS", "Vitality_2_AESTHEMOS", "Surprise_1_AESTHEMOS", "Insight_1_AESTHEMOS", "Sadness_1_AESTHEMOS", "Anger_1_AESTHEMOS", "Boredom_1_AESTHEMOS", "Insight_2_AESTHEMOS", "Sadness_2_AESTHEMOS", "Anger_2_AESTHEMOS", "Uneasiness_2_AESTHEMOS", "Surprise_2_AESTHEMOS", "Awe_2_AESTHEMOS", "Boredom_2_AESTHEMOS", "FeelingOfUgliness_2_AESTHEMOS", "Confusion_2_AESTHEMOS", "Joy_2_AESTHEMOS", "Energy_2_AESTHEMOS")
...
##__Creating Network Analysis DataSet__##
```{r}
...
write.csv(DataSet_NetworkAnalysis, file = "../MainAnalyses/NetworkAnalysis/NetworkAnalysis_DataFile.csv")
```
...
##Save DataSet as CSV in Folder
write.csv(DataSet_Descriptive, file = "../MainAnalyses/DescriptiveAnalysis/DescriptiveAnalysis_DataFile.csv")
```